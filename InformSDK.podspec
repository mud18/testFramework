...
#s.license      = "MIT (example)"
  ...
  s.author             = { "Inform Inc" => "rpidikiti@inform.com" }
  # Or just: s.author    = "Mudit Jain"
  # s.authors            = { "Mudit Jain" => "mudjain18@gmail.com" }
...
s.source       = { :git => "https://github.com/mud18/InformSDKTest.git", :tag => "1.1.0" }
...
s.ios.vendored_framework = "iOS/dynamicFramework/v-0.0.0.1/InformSDK.framework"
end
